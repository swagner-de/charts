...
| flaresolverr | object | `{"enabled":true,"image":{"repository":"ghcr.io/flaresolverr/flaresolverr","tag":"v3.5.2"},"port":8191}` | Flaresolverr Cloudflare bypass proxy configuration |
| flaresolverr.enabled | bool | `true` | Enable Flaresolverr |
| flaresolverr.image | object | `{"repository":"ghcr.io/flaresolverr/flaresolverr","tag":"v3.5.2"}` | Container image configuration |
