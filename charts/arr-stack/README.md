...
| prowlarr | object | `{"enabled":true,"image":{"repository":"ghcr.io/home-operations/prowlarr","tag":"2.6.1.5509"},"persistence":{"config":{"accessMode":"ReadWriteOnce","mountPath":"/config","size":"100Mi","type":"persistentVolumeClaim"}},"port":9696}` | Prowlarr indexer management configuration |
| prowlarr.enabled | bool | `true` | Enable Prowlarr |
| prowlarr.image | object | `{"repository":"ghcr.io/home-operations/prowlarr","tag":"2.6.1.5509"}` | Container image configuration |
| prowlarr.image.repository | string | `"ghcr.io/home-operations/prowlarr"` | Image repository |
| prowlarr.image.tag | string | `"2.6.1.5509"` | Image tag |
...
| radarr | object | `{"enabled":true,"image":{"repository":"ghcr.io/home-operations/radarr","tag":"6.4.1"},"persistence":{"config":{"accessMode":"ReadWriteOnce","mountPath":"/config","size":"100Mi","type":"persistentVolumeClaim"}},"port":7878}` | Radarr movie management configuration |
| radarr.enabled | bool | `true` | Enable Radarr |
| radarr.image | object | `{"repository":"ghcr.io/home-operations/radarr","tag":"6.4.1"}` | Container image configuration |
| radarr.image.repository | string | `"ghcr.io/home-operations/radarr"` | Image repository |
| radarr.image.tag | string | `"6.4.1"` | Image tag |
