...
| [arr-stack](charts/arr-stack) | `0.8.1` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, and Configarr |
...
| [homeassistant](charts/homeassistant) | `1.20.3` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
| [homepage](charts/homepage) | `0.7.2` | Customizable application dashboard for your homelab |
| [immich](charts/immich) | `0.12.9` | Self-hosted photo and video backup solution with machine learning |
| [invidious](charts/invidious) | `0.7.2` | Privacy-focused alternative YouTube frontend with companion service and PostgreSQL |
| [jellyfin](charts/jellyfin) | `0.2.3` | Free software media server for streaming movies, TV, music, and more |
| [mealie](charts/mealie) | `0.22.3` | Self-hosted recipe manager and meal planner |
| [mosquitto](charts/mosquitto) | `0.2.0` | Eclipse Mosquitto MQTT broker with TLS and password authentication |
| [music-assistant](charts/music-assistant) | `0.2.5` | Music Assistant - free, opensource Media player for your local music and online music providers |
| [netra](charts/netra) | `0.2.0` | ASN traffic analysis dashboard for NetFlow/IPFIX flow data |
| [paperless](charts/paperless) | `0.50.9` | Document management system with OCR and full-text search |
...
| [samba](charts/samba) | `0.1.0` | Multi-user Samba SMB file server with per-share encryption and Time Machine support |
