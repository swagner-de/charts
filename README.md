...
| [ghostfolio](charts/ghostfolio) | `0.22.2` | Open source wealth management software |
...
| [homeassistant](charts/homeassistant) | `1.22.3` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
...
| [invidious](charts/invidious) | `0.9.7` | Privacy-focused alternative YouTube frontend with companion service and PostgreSQL |
| [jellyfin](charts/jellyfin) | `0.2.3` | Free software media server for streaming movies, TV, music, and more |
| [mealie](charts/mealie) | `0.24.6` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.55.4` | Document management system with OCR and full-text search |
