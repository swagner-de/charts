...
| [arr-stack](charts/arr-stack) | `0.10.5` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, Configarr, and UmlautAdaptarr |
| [carconnectivity](charts/carconnectivity) | `0.3.0` | Car telemetry data retrieval with plugin support (VW, ABRP, WebUI) |
| [dawarich](charts/dawarich) | `0.2.2` | Self-hosted location history tracker and Google Timeline alternative |
...
| [ghostfolio](charts/ghostfolio) | `0.36.0` | Open source wealth management software |
...
| [homeassistant](charts/homeassistant) | `1.23.3` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
| [homepage](charts/homepage) | `0.9.0` | Customizable application dashboard for your homelab |
| [immich](charts/immich) | `0.18.8` | Self-hosted photo and video backup solution with machine learning |
...
| [linkwarden](charts/linkwarden) | `0.3.4` | Self-hosted collaborative bookmark manager to collect, organize and archive webpages |
...
| [music-assistant](charts/music-assistant) | `0.4.1` | Music Assistant - free, opensource Media player for your local music and online music providers |
| [netra](charts/netra) | `0.3.0` | ASN traffic analysis dashboard for NetFlow/IPFIX flow data |
| [paperless](charts/paperless) | `0.59.5` | Document management system with OCR and full-text search |
