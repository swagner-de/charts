...
| [ghostfolio](charts/ghostfolio) | `0.41.4` | Open source wealth management software |
...
| [immich](charts/immich) | `0.18.16` | Self-hosted photo and video backup solution with machine learning |
...
| [paperless](charts/paperless) | `0.59.13` | Document management system with OCR and full-text search |
