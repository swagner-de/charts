...
| [arr-stack](charts/arr-stack) | `0.9.2` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, and Configarr |
...
| [ghostfolio](charts/ghostfolio) | `0.15.0` | Open source wealth management software |
...
| [immich](charts/immich) | `0.17.0` | Self-hosted photo and video backup solution with machine learning |
...
| [paperless](charts/paperless) | `0.52.0` | Document management system with OCR and full-text search |
