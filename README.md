...
| [dawarich](charts/dawarich) | `0.2.6` | Self-hosted location history tracker and Google Timeline alternative |
...
| [ghostfolio](charts/ghostfolio) | `0.37.0` | Open source wealth management software |
...
| [homeassistant](charts/homeassistant) | `1.24.0` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
...
| [mealie](charts/mealie) | `0.28.4` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.59.6` | Document management system with OCR and full-text search |
