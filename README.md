...
| [dawarich](charts/dawarich) | `0.2.14` | Self-hosted location history tracker and Google Timeline alternative |
...
| [immich](charts/immich) | `0.18.14` | Self-hosted photo and video backup solution with machine learning |
...
| [linkwarden](charts/linkwarden) | `0.3.8` | Self-hosted collaborative bookmark manager to collect, organize and archive webpages |
