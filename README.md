...
| [arr-stack](charts/arr-stack) | `0.10.7` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, Configarr, and UmlautAdaptarr |
| [carconnectivity](charts/carconnectivity) | `0.3.1` | Car telemetry data retrieval with plugin support (VW, ABRP, WebUI) |
| [dawarich](charts/dawarich) | `0.2.12` | Self-hosted location history tracker and Google Timeline alternative |
| [emby](charts/emby) | `0.1.0` | Emby media server for streaming movies, TV, music, and more |
...
| [ghostfolio](charts/ghostfolio) | `0.41.0` | Open source wealth management software |
...
| [homeassistant](charts/homeassistant) | `1.24.2` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
| [homepage](charts/homepage) | `0.10.0` | Customizable application dashboard for your homelab |
| [immich](charts/immich) | `0.18.12` | Self-hosted photo and video backup solution with machine learning |
| [invidious](charts/invidious) | `0.11.4` | Privacy-focused alternative YouTube frontend with companion service and PostgreSQL |
| [jellyfin](charts/jellyfin) | `0.3.0` | Free software media server for streaming movies, TV, music, and more |
| [linkwarden](charts/linkwarden) | `0.3.6` | Self-hosted collaborative bookmark manager to collect, organize and archive webpages |
| [mealie](charts/mealie) | `0.29.1` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.59.11` | Document management system with OCR and full-text search |
