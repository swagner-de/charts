...
| [arr-stack](charts/arr-stack) | `0.10.4` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, Configarr, and UmlautAdaptarr |
...
| [ghostfolio](charts/ghostfolio) | `0.35.0` | Open source wealth management software |
...
| [paperless](charts/paperless) | `0.59.2` | Document management system with OCR and full-text search |
