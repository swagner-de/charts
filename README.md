...
| [arr-stack](charts/arr-stack) | `0.8.3` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, and Configarr |
| [carconnectivity](charts/carconnectivity) | `0.1.2` | Car telemetry data retrieval with plugin support (VW, ABRP, WebUI) |
...
| [ghostfolio](charts/ghostfolio) | `0.3.0` | Open source wealth management software |
...
| [homeassistant](charts/homeassistant) | `1.21.0` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
...
| [invidious](charts/invidious) | `0.7.12` | Privacy-focused alternative YouTube frontend with companion service and PostgreSQL |
| [jellyfin](charts/jellyfin) | `0.2.3` | Free software media server for streaming movies, TV, music, and more |
| [mealie](charts/mealie) | `0.22.13` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.50.19` | Document management system with OCR and full-text search |
