...
| [immich](charts/immich) | `0.14.0` | Self-hosted photo and video backup solution with machine learning |
| [invidious](charts/invidious) | `0.7.4` | Privacy-focused alternative YouTube frontend with companion service and PostgreSQL |
| [jellyfin](charts/jellyfin) | `0.2.3` | Free software media server for streaming movies, TV, music, and more |
| [mealie](charts/mealie) | `0.22.5` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.50.11` | Document management system with OCR and full-text search |
