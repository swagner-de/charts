...
| [arr-stack](charts/arr-stack) | `0.10.13` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, Configarr, and UmlautAdaptarr |
| [carconnectivity](charts/carconnectivity) | `0.3.1` | Car telemetry data retrieval with plugin support (VW, ABRP, WebUI) |
| [dawarich](charts/dawarich) | `0.3.0` | Self-hosted location history tracker and Google Timeline alternative |
...
| [ghostfolio](charts/ghostfolio) | `0.43.1` | Open source wealth management software |
...
| [homeassistant](charts/homeassistant) | `1.24.6` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
| [homepage](charts/homepage) | `0.11.0` | Customizable application dashboard for your homelab |
| [immich](charts/immich) | `0.20.3` | Self-hosted photo and video backup solution with machine learning |
