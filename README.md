...
| [ghostfolio](charts/ghostfolio) | `0.30.0` | Open source wealth management software |
...
| [homeassistant](charts/homeassistant) | `1.23.1` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
| [homepage](charts/homepage) | `0.8.0` | Customizable application dashboard for your homelab |
| [immich](charts/immich) | `0.18.2` | Self-hosted photo and video backup solution with machine learning |
| [invidious](charts/invidious) | `0.11.0` | Privacy-focused alternative YouTube frontend with companion service and PostgreSQL |
| [jellyfin](charts/jellyfin) | `0.3.0` | Free software media server for streaming movies, TV, music, and more |
| [linkwarden](charts/linkwarden) | `0.2.0` | Self-hosted collaborative bookmark manager to collect, organize and archive webpages |
| [mealie](charts/mealie) | `0.27.0` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.58.2` | Document management system with OCR and full-text search |
...
| [wanderer](charts/wanderer) | `0.1.0` | Self-hosted trail database and route planner for hiking, biking and other outdoor activities |
