...
| [arr-stack](charts/arr-stack) | `0.9.3` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, and Configarr |
...
| [ghostfolio](charts/ghostfolio) | `0.18.0` | Open source wealth management software |
...
| [immich](charts/immich) | `0.17.6` | Self-hosted photo and video backup solution with machine learning |
...
| [mealie](charts/mealie) | `0.24.2` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.53.2` | Document management system with OCR and full-text search |
