...
| [linkwarden](charts/linkwarden) | `0.4.0` | Self-hosted collaborative bookmark manager to collect, organize and archive webpages |
| [mealie](charts/mealie) | `0.31.0` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.62.4` | Document management system with OCR and full-text search |
