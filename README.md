...
| [arr-stack](charts/arr-stack) | `0.10.1` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, Configarr, and UmlautAdaptarr |
| [carconnectivity](charts/carconnectivity) | `0.3.0` | Car telemetry data retrieval with plugin support (VW, ABRP, WebUI) |
| [dawarich](charts/dawarich) | `0.1.1` | Self-hosted location history tracker and Google Timeline alternative |
...
| [ghostfolio](charts/ghostfolio) | `0.31.0` | Open source wealth management software |
...
| [linkwarden](charts/linkwarden) | `0.3.0` | Self-hosted collaborative bookmark manager to collect, organize and archive webpages |
