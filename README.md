...
| [homeassistant](charts/homeassistant) | `1.24.5` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
| [homepage](charts/homepage) | `0.11.0` | Customizable application dashboard for your homelab |
| [immich](charts/immich) | `0.20.2` | Self-hosted photo and video backup solution with machine learning |
