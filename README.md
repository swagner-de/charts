...
| [homeassistant](charts/homeassistant) | `1.19.0` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
...
| [paperless](charts/paperless) | `0.50.0` | Document management system with OCR and full-text search |
