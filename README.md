...
|-------|---------|-------------|
| [adguard-home](charts/adguard-home) | `0.7.1` | DNS-level ad and tracker blocking with optional Prometheus exporter |
...
| [homeassistant](charts/homeassistant) | `1.13.1` | Home automation platform with optional LDAP, Matter bridge, and CNPG database support |
...
| [mealie](charts/mealie) | `0.20.0` | Self-hosted recipe manager and meal planner |
