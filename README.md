...
| [arr-stack](charts/arr-stack) | `0.10.2` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, Configarr, and UmlautAdaptarr |
| [carconnectivity](charts/carconnectivity) | `0.3.0` | Car telemetry data retrieval with plugin support (VW, ABRP, WebUI) |
| [dawarich](charts/dawarich) | `0.1.3` | Self-hosted location history tracker and Google Timeline alternative |
...
| [ghostfolio](charts/ghostfolio) | `0.32.2` | Open source wealth management software |
...
| [immich](charts/immich) | `0.18.4` | Self-hosted photo and video backup solution with machine learning |
