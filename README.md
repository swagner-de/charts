...
| [arr-stack](charts/arr-stack) | `0.6.0` | Media automation stack with Sonarr, Radarr, Prowlarr, Bazarr, Flaresolverr, and Configarr |
...
| [immich](charts/immich) | `0.10.2` | Self-hosted photo and video backup solution with machine learning |
...
| [paperless](charts/paperless) | `0.47.0` | Document management system with OCR and full-text search |
