...
| [akvorado](charts/akvorado) | `0.3.1` | NetFlow/IPFIX/sFlow collector with ClickHouse analytics |
...
| [freeradius](charts/freeradius) | `0.1.0` | FreeRADIUS server with LDAP backend for WPA Enterprise and MAC authentication |
