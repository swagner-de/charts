...
| [ghostfolio](charts/ghostfolio) | `0.23.0` | Open source wealth management software |
...
| [immich](charts/immich) | `0.17.12` | Self-hosted photo and video backup solution with machine learning |
| [invidious](charts/invidious) | `0.10.0` | Privacy-focused alternative YouTube frontend with companion service and PostgreSQL |
| [jellyfin](charts/jellyfin) | `0.2.3` | Free software media server for streaming movies, TV, music, and more |
| [mealie](charts/mealie) | `0.25.0` | Self-hosted recipe manager and meal planner |
...
| [paperless](charts/paperless) | `0.57.0` | Document management system with OCR and full-text search |
